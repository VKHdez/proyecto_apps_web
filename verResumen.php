				...
				<span class="icon-bar"></span>
                    ...
                    <div id="navbar" class="collapse navbar-collapse navbar-right">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="active"><a href="verResumen.php">Resumen</a></li>
...
<!--
***************************************************************************
cuerpo del body ajajja
-->
<?PHP

    //mostrar taba con los resumenes en la base de datos
    $link=mysqli_connect("localhost","root","");
    mysqli_select_db($link,"apuntesdb");
    $result=mysqli_query($link,"select * from apuntes");
    echo "<table border=1>";
    echo "<TR><td> Id Apunte </td><td> Materia </td><td> Titulo </td><td> Autor </td><td> Resumen </td></TR>";
    while($row = mysqli_fetch_array($result))
    {
       ...
       <a href=\"verResumen2.php?id=%s\"><img src='actualiza.jpg' width='25' height='25' border='0'></a></td></TR>";
